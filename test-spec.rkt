...
(spec "symbol=? operator works" (should symbol=? 'pear 'pear))
(spec "lambda works" (should (lambda (x y) (= x y)) 1 1))
...
(spec "\"apple\" equals \"apple\"" (should eq? "apple" "apple"))
(spec "\"apple\" equals \"orange\" ~ intentional fail" (should eq? "apple" "orange"))
